...
describe "additional_service_records/edit" do
  before(:each) do
  ...
  it "renders the edit additional_service_record form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => additional_service_records_path(@additional_service_record), :method => "post" do
